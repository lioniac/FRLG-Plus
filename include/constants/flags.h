...
// Custom
#define CUSTOM_FLAGS_START      (FLAG_0x8FF + 1)
#define FLAG_SET_WALL_CLOCK     (CUSTOM_FLAGS_START + 0x0)
#define FLAG_SYS_CLOCK_SET      (CUSTOM_FLAGS_START + 0x1)

#define DAILY_FLAGS_START       (CUSTOM_FLAGS_START + 0x2)
#define FLAG_DAILY_FLAG_00      (DAILY_FLAGS_START  + 0x00)
#define FLAG_DAILY_FLAG_01      (DAILY_FLAGS_START  + 0x01)
#define FLAG_DAILY_FLAG_02      (DAILY_FLAGS_START  + 0x02)
#define FLAG_DAILY_FLAG_03      (DAILY_FLAGS_START  + 0x03)
#define FLAG_DAILY_FLAG_04      (DAILY_FLAGS_START  + 0x04)
#define FLAG_DAILY_FLAG_05      (DAILY_FLAGS_START  + 0x05)
#define FLAG_DAILY_FLAG_06      (DAILY_FLAGS_START  + 0x06)
#define FLAG_DAILY_FLAG_07      (DAILY_FLAGS_START  + 0x07)
#define FLAG_DAILY_FLAG_08      (DAILY_FLAGS_START  + 0x08)
#define FLAG_DAILY_FLAG_09      (DAILY_FLAGS_START  + 0x09)
#define FLAG_DAILY_FLAG_0A      (DAILY_FLAGS_START  + 0x0A)
#define FLAG_DAILY_FLAG_0B      (DAILY_FLAGS_START  + 0x0B)
#define FLAG_DAILY_FLAG_0C      (DAILY_FLAGS_START  + 0x0C)
#define FLAG_DAILY_FLAG_0D      (DAILY_FLAGS_START  + 0x0D)
#define FLAG_DAILY_FLAG_0E      (DAILY_FLAGS_START  + 0x0E)
#define FLAG_DAILY_FLAG_0F      (DAILY_FLAGS_START  + 0x0F)
#define FLAG_DAILY_FLAG_10      (DAILY_FLAGS_START  + 0x10)
#define FLAG_DAILY_FLAG_11      (DAILY_FLAGS_START  + 0x11)
#define FLAG_DAILY_FLAG_12      (DAILY_FLAGS_START  + 0x12)
#define FLAG_DAILY_FLAG_13      (DAILY_FLAGS_START  + 0x13)
#define FLAG_DAILY_FLAG_14      (DAILY_FLAGS_START  + 0x14)
#define FLAG_DAILY_FLAG_15      (DAILY_FLAGS_START  + 0x15)
#define FLAG_DAILY_FLAG_16      (DAILY_FLAGS_START  + 0x16)
#define FLAG_DAILY_FLAG_17      (DAILY_FLAGS_START  + 0x17)
#define FLAG_DAILY_FLAG_18      (DAILY_FLAGS_START  + 0x18)
#define FLAG_DAILY_FLAG_19      (DAILY_FLAGS_START  + 0x19)
#define FLAG_DAILY_FLAG_1A      (DAILY_FLAGS_START  + 0x1A)
#define FLAG_DAILY_FLAG_1B      (DAILY_FLAGS_START  + 0x1B)
#define FLAG_DAILY_FLAG_1C      (DAILY_FLAGS_START  + 0x1C)
#define FLAG_DAILY_FLAG_1D      (DAILY_FLAGS_START  + 0x1D)
#define FLAG_DAILY_FLAG_1E      (DAILY_FLAGS_START  + 0x1E)
#define FLAG_DAILY_FLAG_1F      (DAILY_FLAGS_START  + 0x1F)
#define FLAG_DAILY_FLAG_20      (DAILY_FLAGS_START  + 0x20)
#define FLAG_DAILY_FLAG_21      (DAILY_FLAGS_START  + 0x21)
#define FLAG_DAILY_FLAG_22      (DAILY_FLAGS_START  + 0x22)
#define FLAG_DAILY_FLAG_23      (DAILY_FLAGS_START  + 0x23)
#define FLAG_DAILY_FLAG_24      (DAILY_FLAGS_START  + 0x24)
#define FLAG_DAILY_FLAG_25      (DAILY_FLAGS_START  + 0x25)
#define FLAG_DAILY_FLAG_26      (DAILY_FLAGS_START  + 0x26)
#define FLAG_DAILY_FLAG_27      (DAILY_FLAGS_START  + 0x27)
#define FLAG_DAILY_FLAG_28      (DAILY_FLAGS_START  + 0x28)
#define FLAG_DAILY_FLAG_29      (DAILY_FLAGS_START  + 0x29)
#define FLAG_DAILY_FLAG_2A      (DAILY_FLAGS_START  + 0x2A)
#define FLAG_DAILY_FLAG_2B      (DAILY_FLAGS_START  + 0x2B)
#define FLAG_DAILY_FLAG_2C      (DAILY_FLAGS_START  + 0x2C)
#define FLAG_DAILY_FLAG_2D      (DAILY_FLAGS_START  + 0x2D)
#define FLAG_DAILY_FLAG_2E      (DAILY_FLAGS_START  + 0x2E)
#define FLAG_DAILY_FLAG_2F      (DAILY_FLAGS_START  + 0x2F)
#define FLAG_DAILY_FLAG_30      (DAILY_FLAGS_START  + 0x30)
#define FLAG_DAILY_FLAG_31      (DAILY_FLAGS_START  + 0x31)
#define FLAG_DAILY_FLAG_32      (DAILY_FLAGS_START  + 0x32)
#define FLAG_DAILY_FLAG_33      (DAILY_FLAGS_START  + 0x33)
#define FLAG_DAILY_FLAG_34      (DAILY_FLAGS_START  + 0x34)
#define FLAG_DAILY_FLAG_35      (DAILY_FLAGS_START  + 0x35)
#define FLAG_DAILY_FLAG_36      (DAILY_FLAGS_START  + 0x36)
#define FLAG_DAILY_FLAG_37      (DAILY_FLAGS_START  + 0x37)
#define FLAG_DAILY_FLAG_38      (DAILY_FLAGS_START  + 0x38)
#define FLAG_DAILY_FLAG_39      (DAILY_FLAGS_START  + 0x39)
#define FLAG_DAILY_FLAG_3A      (DAILY_FLAGS_START  + 0x3A)
#define FLAG_DAILY_FLAG_3B      (DAILY_FLAGS_START  + 0x3B)
#define FLAG_DAILY_FLAG_3C      (DAILY_FLAGS_START  + 0x3C)
#define FLAG_DAILY_FLAG_3D      (DAILY_FLAGS_START  + 0x3D)
#define FLAG_DAILY_FLAG_3E      (DAILY_FLAGS_START  + 0x3E)
#define FLAG_DAILY_FLAG_3F      (DAILY_FLAGS_START  + 0x3F)
#define DAILY_FLAGS_END         (DAILY_FLAGS_START  + 0x3F)

#define CUSTOM_FLAGS_END (DAILY_FLAGS_START + 0x3F)

#define FLAGS_COUNT (CUSTOM_FLAGS_END)
